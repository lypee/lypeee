...
<script type="text/javascript" src="${pageContext.request.contextPath}/pages/user.login.js"></script>
...
<body>
	...
	<div class="register">
		...
		<div class="div1">
			...
			<a onclick="refreshCheckCodeButton()" href="#" id="refreshCheckCode"><img src="checkCode"></a>
		</div>
