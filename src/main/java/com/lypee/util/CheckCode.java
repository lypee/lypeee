...
public class CheckCode {
    public void generationCheckCode(HttpServletRequest httpServletRequest ,
                                    HttpServletResponse httpServletResponse)throws  Exception
    {
        ...
        int heihgt = 30 ,width=120 ,xpyl=5 ,ypyl=22 ,bang=20 ;
        BufferedImage bufferedImage = new BufferedImage(width ,heihgt ,BufferedImage.TYPE_INT_RGB);
        Graphics2D g = (Graphics2D)bufferedImage.getGraphics();
        g.setColor(Color.LIGHT_GRAY);
        g.fillRect(0,0,width , heihgt);

        g.setColor(Color.BLUE);
        g.drawRect(0,0,width-1 ,heihgt -1);
        for(int i = 0 ;  i< 5 ; i++)
        {
            g.setColor(Color.RED);
            g.drawLine(randNum(0, width), randNum(0, heihgt), randNum(0, width), randNum(0, heihgt));
        }
